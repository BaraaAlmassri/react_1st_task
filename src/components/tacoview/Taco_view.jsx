...
export default function Taco_view(props) {
  const { tacos } = props;
  return (
    <>
      <div className="tacos group overflow-hidden rounded-2xl bg-white border-2 border-gray-200/80 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-red-200">
